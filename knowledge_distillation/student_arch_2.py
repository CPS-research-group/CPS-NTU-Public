...
class Mod2BetaVae(torch.nn.Module):
    ...
    def __init__(self,
                 ...
                 input_d: Tuple[int],
                 batch: int = 1) -> None:
        super(Mod2BetaVae, self).__init__()
        self.batch = batch
        ...
        self.enc_dense1 = torch.nn.Linear(self.hidden_units, 1000)
        ...
        self.dec_dense1 = torch.nn.Linear(1000, self.hidden_units)
...
class Mod2Encoder(torch.nn.Module):
