...
#        weights_f = io.BytesIO(pkgutil.get_data('beta_vae_ood_detector', weights))
#        self.encoder.load_state_dict(torch.load(weights_f))
        self.encoder.eval()
